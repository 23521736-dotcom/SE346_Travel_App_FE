...
const styles = StyleSheet.create({
    ...
    filterChip: { paddingHorizontal: 20, paddingVertical: 8, borderRadius: 20, backgroundColor: '#fff', borderWidth: 1, borderColor: '#e2e8f0', marginRight: 10 },
    ...
    detailText: { fontSize: 13, fontWeight: 'bold', color: '#0f6c82' },
