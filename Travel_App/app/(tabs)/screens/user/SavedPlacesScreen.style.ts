...
const styles = StyleSheet.create({
    ...
    searchInput: { flex: 1, backgroundColor: '#f1f5f9', borderRadius: 25, paddingLeft: 45, paddingRight: 45, height: 45, color: '#333' },
    filtersScroll: { flexDirection: 'row' },
    filterChip: { paddingHorizontal: 20, paddingVertical: 8, borderRadius: 20, backgroundColor: '#E3F2FD', borderWidth: 1, borderColor: '#E3F2FD', marginRight: 10 },
    filterChipActive: { backgroundColor: '#00AEEF', borderColor: '#00AEEF' },
    filterText: { color: '#000', fontSize: 14, fontWeight: '600' },
    filterTextActive: { color: '#000' },
    listContainer: { flex: 1 },
    listContent: { padding: 20, paddingBottom: 100 },
    card: { backgroundColor: '#fff', borderRadius: 20, marginBottom: 20, overflow: 'hidden', elevation: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.1, shadowRadius: 4 },
    imageContainer: { height: 180, width: '100%', position: 'relative' },
    cardImage: { width: '100%', height: '100%' },
    discountBadge: { position: 'absolute', top: 15, left: 15, flexDirection: 'row', alignItems: 'center', columnGap: 4, backgroundColor: '#0f6c82', paddingHorizontal: 9, paddingVertical: 5, borderRadius: 999 },
    ...
    ratingBadge: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff7ed', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 6, borderWidth: 1, borderColor: '#ffedd5' },
    ratingText: { fontSize: 12, fontWeight: 'bold', color: '#c2410c', marginLeft: 4 },
    ...
    detailText: { fontSize: 13, fontWeight: '800', color: '#00AEEF' },
