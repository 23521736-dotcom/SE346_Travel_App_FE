        ...
        <View style={styles.card}>
          ...
          <View style={styles.bottomSettingsRow}>
            ...
            <View style={{ alignItems: 'flex-end' }}>
              ...
              <Text style={styles.budgetAmount}>${trip.budget} <Text style={styles.budgetUnit}>/ person</Text></Text>
            </View>
          </View>
        </View>
          ...
          <View>
            {trip.itineraryData?.map((day, index) => {
              ...
              const totalCost = day.locations.reduce((sum, location) => {
                const value = Number(location.cost.replace(/[^0-9.]/g, '')) || 0;
                return sum + value;
              }, 0);
                  ...
                  >
                    ...
                    <View style={styles.dayTitleCol}>
                      <Text style={isExpanded ? styles.dayTitleExpanded : styles.dayTitleCollapsed}>
                        {day.title}: {isExpanded ? trip.title : day.locations.length ? day.locations[0].name : 'Empty'}
                      </Text>
                      <Text style={styles.daySubtitle}>
                        {day.date} - {day.locations.length} Locations - Budget: ${totalCost}
                      </Text>
                    </View>
                            ...
                            <View style={styles.timelineCard}>
                              ...
                              <View style={styles.timelineInfo}>
                                ...
                                <View style={styles.estimatePill}>
                                  <Text style={styles.estimateText}>EST: {loc.cost}</Text>
                                </View>
                              </View>
                            </View>
                          </View>
